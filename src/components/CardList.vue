<template>
    <b-list-group  id="card_list" >
        <b-list-group-item style="overflow-y:hidden;" v-for="(card,index) in card_list" :key="card.id"
                           @click="$emit('open_modal', card)" class="border-secondary">
...
<script>
    import DrawCardVoteBar from "../components/draw_page_components/DrawCardVoteBar.vue";

    export default {
        name: "CardList",
        props: ['card_list'],
        components: {DrawCardVoteBar}
    }
</script>
